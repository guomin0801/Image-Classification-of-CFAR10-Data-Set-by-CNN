...
class Solver(object):
    ...
    def _reset(self):
        ...
        for p in self.model.params:
            # d = {k: v for k, v in self.optim_config.iteritems()} # Python3.5中：iteritems变为items
    ...
    def _step(self):
        ...
        # for p, w in self.model.params.iteritems(): # Python3.5中：iteritems变为items
    ...
    def check_accuracy(self, X, y, num_samples=None, batch_size=100):
        ...
        if N % batch_size != 0:
            num_batches += 1
        y_pred = []
        # for i in range(num_batches):  # TypeError: 'float' object cannot be interpret as an integer
    ...
    def train(self):
        ...
        # 迭代总的次数
        # for t in range(num_iterations):  # TypeError: 'float' object cannot be interpret as an integer
        for t in range(int(num_iterations)):
            ...
            if first_it or last_it or epoch_end:
                ...
                if val_acc > self.best_val_acc:
                    ...
                    self.best_params = {}
                    # for k, v in self.model.params.iteritems(): # Python3.5中：iteritems变为items
