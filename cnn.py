...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # 高斯分布 这一层是全连接层，输入的维数是N*H*W/4,除以4是因为通过了max_pooling层,
        # 因为通过padding保留了原来大小，输出是hidden_dim的维数
        ...
        # iteritems是为python2环境中dict的函数,在python3报错，将iteritems改为items即可
    ...
    def loss(self, X, y=None):
        ...
        a1, cache1 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)  # first layer
